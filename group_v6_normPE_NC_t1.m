function group_v6_normPE_NC_t1(varargin)
addpath('C:\Users\SN\Desktop\spm12')

indir = 'C:\Users\SN\Google Drive\p1.UG2_fMRI\180422_eta.8\5.indiv\v6_normPE\NC';
outdir = 'C:\Users\SN\Google Drive\p1.UG2_fMRI\180422_eta.8\6.group\v6_normPE_NC';
...
for i = 1:length(subj)    
    ...
    cd(output_dir);
    save 'batch_v6_normPE_NC' matlabbatch;
