...
%% Trial 6-35
for i = 1:nP        
    trials = find(A(i).NC.R.xR>5 & A(i).NC.R.xR<36);
    OFFER{i,1} = A(i).NC.R.offer(trials);
    RESP{i,1} = A(i).NC.R.choice(trials);    
end
...
saveName = 'static_norm_cap2_t20_30trials_NC';


%% Model setting
Model = {'static_norm_f3_cap2_t20_etaf'
         };                        % Candidate models { 'xx' ; 'xx'}
