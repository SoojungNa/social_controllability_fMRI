...
infile = 'recover_nRv_f3_cap2_t20_etaf_IC.mat'; % param_est, param_tru, R, P


%% Output file
oDir = indir;
oFile = 'plot_recover_IC2.pdf';
...
color_ic = Blue1;
%color_ic = magenta*.7;  %70 120 200     dark
...
for i = 1:length(poi)
    ...
    s22 = scatter(x{i}, y{i}, dsz, color_ic, 'filled');
