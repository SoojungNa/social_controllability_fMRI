...
for t = 1:nIter  
    ...
    for i = 1:nP
        ...
        x(5) = 2*x(5);        
        param{t}(i,:,m) = x;
        [offer, resp] = simulate_0step_nc(x);
        [best, dic, param_est] = fit_6models(offer, resp);
        results{i,m,t} = {best; dic; offer; resp; param_est};        
        dic_sum(m, :) = dic_sum(m, :) + dic;
        ...
        x(5) = 2*x(5);        
        param{t}(i,:,m) = x;
        [offer, resp] = simulate_1step_nc(x);
        [best, dic, param_est] = fit_6models(offer, resp);
        results{i,m,t} = {best; dic; offer; resp; param_est};        
        dic_sum(m, :) = dic_sum(m, :) + dic;
        ...
        x(5) = 2*x(5);        
        param{t}(i,:,m) = x;
        [offer, resp] = simulate_2step_nc(x);
        [best, dic, param_est] = fit_6models(offer, resp);
        results{i,m,t} = {best; dic; offer; resp; param_est};     
        dic_sum(m, :) = dic_sum(m, :) + dic;
        ...
        x(5) = 2*x(5);        
        param{t}(i,:,m) = x;
        [offer, resp] = simulate_3step_nc(x);
        [best, dic, param_est] = fit_6models(offer, resp);
        results{i,m,t} = {best; dic; offer; resp; param_est};        
        dic_sum(m, :) = dic_sum(m, :) + dic;
        ...
        x(5) = 2*x(5);        
        param{t}(i,:,m) = x;
        [offer, resp] = simulate_4step_nc(x);
        [best, dic, param_est] = fit_6models(offer, resp);
        results{i,m,t} = {best; dic; offer; resp; param_est};        
        dic_sum(m, :) = dic_sum(m, :) + dic;
...
save('CM_nc.mat', 'results', 'param', 'dic_avg', 'best_iter', 'CM', 'tEnd', 'tTotal');
