function group_v1_xV_IC_t1(varargin)
addpath('C:\Users\SN\Desktop\spm12')

indir = 'C:\Users\SN\Google Drive\p1.UG2_fMRI\180422_eta.8\5.indiv\v1_xV\IC';
outdir = 'C:\Users\SN\Google Drive\p1.UG2_fMRI\180422_eta.8\6.group\v1_xV_IC';
...
for i = 1:length(subj)    
    ...
    cd(output_dir);
    save 'batch_v1_xV_IC' matlabbatch;
