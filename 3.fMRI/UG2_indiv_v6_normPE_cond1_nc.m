...
matlabbatch{1}.spm.stats.fmri_spec.sess(1).scans            = {sw2};
...
matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(aa).onset    = event.block2{aa};
...
matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(1).pmod(1).param =pmod.block2{2};
matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(1).pmod(1).poly = 1;

matlabbatch{1}.spm.stats.fmri_spec.sess(1).multi_reg = {rp2};
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'normPE_nc';
