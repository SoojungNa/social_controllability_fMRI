function run_UG2_indiv_v6_normPE(varargin)

addpath('C:\Users\SN\Desktop\spm12')
addpath('C:\Users\SN\Google Drive\p1.UG2_fMRI\180422_eta.8\5.indiv')

data_dir = 'C:\Users\SN\Google Drive\p1.UG2_fMRI\3.fMRI\data_preproc';
output_dir = 'C:\Users\SN\Google Drive\p1.UG2_fMRI\180422_eta.8\5.indiv\v6_normPE';
event_dir = 'C:\Users\SN\Google Drive\p1.UG2_fMRI\180422_eta.8\3.event\v1';
pmod_dir = 'C:\Users\SN\Google Drive\p1.UG2_fMRI\180422_eta.8\4.pmod\v6';
...
for i= 1:length(subj)
    ...
    %% run analysis    
    if order == 1        
        UG2_indiv_v6_normPE_cond1_ic;                
        UG2_indiv_v6_normPE_cond1_nc; 
    elseif order == 2        
        UG2_indiv_v6_normPE_cond2_ic;
        UG2_indiv_v6_normPE_cond2_nc;
    end
