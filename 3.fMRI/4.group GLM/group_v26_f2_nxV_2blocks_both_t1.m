function group_v26_f2_nxV_2blocks_both_t1(varargin)
addpath('C:\Users\SN\Desktop\spm12')

indir = 'C:\Users\SN\Google Drive\p1.UG2_fMRI\180422_eta.8\5.indiv\v26_f2_nxV_2blocks';
outdir = 'C:\Users\SN\Google Drive\p1.UG2_fMRI\180422_eta.8\6.group\v26_f2_nxV_2blocks_both';
...
for i = 1:length(subj)    
    ...
    copyfile(fullfile(indir, subj(i).name, ['con_0003.nii']), ...
    ...
    cd(output_dir);
    save 'batch_v26_f2_nxV_both' matlabbatch;
